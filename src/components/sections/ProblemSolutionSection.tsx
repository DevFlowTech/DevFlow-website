...
export default function ProblemSolutionSection() {
  return (
    <section id="problem" className="pb-12 md:pb-24 pt-0 bg-devflow-black">
      <div className="section-container">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            <motion.span
              ...
              className="text-sm font-medium text-devflow-green uppercase tracking-widest mb-3 block"
            >
              The Challenge
            </motion.span>
            ...
            <motion.h2
              variants={staggerItem}
              className="font-display text-2xl md:text-4xl lg:text-[2.75rem] font-semibold text-white leading-tight tracking-tight mb-4 text-shadow-soft"
            >
              <TextReveal>
            ...
            <motion.div
              variants={staggerItem}
              className="space-y-4 md:space-y-5 text-base md:text-lg text-devflow-gray-300 leading-relaxed"
            >
              <p>
        ...
        <div className="mt-20 md:mt-32">
          ...
          >
            ...
            <motion.h2
              variants={staggerItem}
              className="font-display text-2xl md:text-4xl lg:text-[2.75rem] font-semibold text-white leading-tight tracking-tight mb-6 md:mb-8 text-shadow-soft"
            >
              <TextReveal>
          ...
          >
            {[
              ...
              >
                <SpotlightCard
                  className="h-full p-8 bg-devflow-dark border border-white/[0.08] rounded-2xl transition-all duration-300 hover:border-devflow-green/40 hover:shadow-2xl hover:shadow-devflow-green/5"
                  spotlightColor="rgba(186, 230, 84, 0.12)"
                >
