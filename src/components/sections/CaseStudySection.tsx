            ...
            <motion.div variants={staggerItem}>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li
                    key={item}
                    className="flex items-center gap-3 text-devflow-gray-300"
                  >
                    <svg
          ...
          >
            ...
            >
              <div className="p-8 md:p-10 relative overflow-hidden">
                ...
                <h3 className="text-sm font-medium text-devflow-gray-300 uppercase tracking-widest mb-8 relative z-10">
                  Business Impact
                </h3>
                ...
                <div className="space-y-8 relative z-10">
                  <div>
                    ...
                    <p className="text-sm text-devflow-gray-300 mt-1 opacity-80">
                  ...
                  <div className="grid grid-cols-2 gap-6 pt-8 border-t border-white/[0.06]">
                    <div>
                      ...
                      <p className="text-xs text-devflow-gray-300 uppercase tracking-wide">
                        Missed Orders
                      </p>
                    </div>
                    <div>
