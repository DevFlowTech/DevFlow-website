...
const services = [
  {
    ...
    codeSnippet: "const site = new Website({\n  speed: 'lightning',\n  seo: 'optimized'\n});",
  },
  {
  ...
  },
  {
    ...
    codeSnippet: "on('order').then(syncInventory)\n  .then(notifyTeam);",
  },
  {
    ...
    >
      ...
      <div className="section-container relative z-10">
        ...
        >
          ...
          <motion.h2
            variants={staggerItem}
            className="font-display text-2xl md:text-4xl lg:text-[2.75rem] font-semibold text-white leading-tight tracking-tight mb-4 md:mb-6 text-shadow-soft"
          >
          ...
          <motion.p
            variants={staggerItem}
            className="text-base md:text-lg text-devflow-gray-300 leading-relaxed"
          >
          ...
          {services.map((service) => (
            <motion.div
              ...
              whileHover={{
                ...
                boxShadow: "0 20px 40px -20px rgba(0, 0, 0, 0.5), 0 0 20px rgba(186, 230, 84, 0.05)"
              }}
              className="p-6 md:p-8 bg-devflow-dark border border-white/[0.06] rounded-2xl transition-all duration-300 group cursor-pointer relative overflow-hidden"
            >
              {/* Foreground Glow */}
              <div className="absolute inset-0 bg-gradient-to-br from-devflow-green/[0.03] via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              ...
              <div className="mt-6 pt-6 border-t border-white/[0.04] md:opacity-0 md:group-hover:opacity-100 opacity-100 transform md:translate-y-2 md:group-hover:translate-y-0 transition-all duration-500">
                <div className="bg-black/40 rounded-lg p-3 md:p-4 border border-white/[0.06] shadow-inner relative overflow-hidden">
                  ...
                  <code className="text-[9px] md:text-xs font-mono text-devflow-green/80 leading-relaxed block whitespace-pre overflow-x-auto">
                    {service.codeSnippet}
                  </code>
                </div>
              </div>
